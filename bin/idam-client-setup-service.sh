...
curl -XPOST \
 ...
 -d '{ "activationRedirectUrl": "", "allowedRoles": ["ccd-import", "caseworker", "caseworker-sscs", "caseworker-sscs-systemupdate", "caseworker-sscs-clerk", "caseworker-sscs-anonymouscitizen", "caseworker-sscs-callagent", "caseworker-sscs-judge", "caseworker-sscs-dwpresponsewriter", "caseworker-sscs-registrar", "caseworker-sscs-superuser", "caseworker-sscs-panelmember", "caseworker-sscs-bulkscan"], "description": "'${CLIENT_ID}'", "label": "'${CLIENT_ID}'", "oauth2ClientId": "'${CLIENT_ID}'", "oauth2ClientSecret": "'${CLIENT_SECRET}'", "oauth2RedirectUris": ["http://localhost:3451/oauth2redirect", "http://localhost:3000/sign-in", "http://localhost:3002/auth/oauth2/callback", "https://localhost:3000/authenticated", "http://localhost:4502/authenticated", "http://localhost:3002/oauth2/callback"], "oauth2Scope": "'"${SCOPE}"'", "onboardingEndpoint": "string", "onboardingRoles": ["ccd-import", "caseworker", "caseworker-sscs", "caseworker-sscs-systemupdate", "caseworker-sscs-clerk", "caseworker-sscs-anonymouscitizen", "caseworker-sscs-callagent", "caseworker-sscs-judge", "caseworker-sscs-dwpresponsewriter", "caseworker-sscs-registrar", "caseworker-sscs-superuser", "caseworker-sscs-panelmember", "caseworker-sscs-bulkscan"], "selfRegistrationAllowed": true}'
