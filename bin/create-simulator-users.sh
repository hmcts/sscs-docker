...
./bin/simulator-create-caseworker.sh caseworker-sscs,caseworker,caseworker-sscs-superuser,caseworker-wa-task-configuration,caseworker-wa,caseworker-ia-caseofficer,caseworker-sscs-registrar local.test@example.com ##ia temp again
./bin/simulator-create-caseworker.sh caseworker-sscs-systemupdate,caseworker-sscs,caseworker,caseworker-wa-task-configuration,caseworker-wa,caseworker-sscs-registrar system.update@hmcts.net
